# Goal: Generate detection curves across six tau values of three detection functions:
#       half-normal, negative-exponential, and hazard-rate with varying tau.
# Date: 2026-07-06
# Author: Betty Shen
rm(list = ls())
library(ggplot2)
...
tau_units <-  c(1, 1.5, 2, 2.5, 3, 3.5)
tau_m_vals <- tau_units * 100

# Hazard-rate shape parameter (controls shoulder)
b_vals <- c(3)
...
output_dir <- "/Volumes/T7/Chapter2/DataIntegration/Results/DataSimulation/Revision/Plot"
dir.create(output_dir, showWarnings = FALSE, recursive = TRUE)
png_file <- file.path(output_dir, "detection_curves_tau_b_revision.png")
